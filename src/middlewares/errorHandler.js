    ...
    if (
      ...
      if (Number(error.code) === 202 || Number(error.code) === 200) {
        ...
        await Slack.sendMessage({
          channel: 'notify-elearning',
          accessToken: 'xoxp-374681962228-375797693286-3419589344663-98325e9314cb7bebbec56ebaf3bce2a9',
          type: 'mrkdwn',
        ...
        console.log('a', { channel: CONFIG['SLACK_ERROR_LOGGER'], accessToken: CONFIG['SLACK_ACCESS_TOKEN_APP'] });
